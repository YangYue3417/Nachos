        ...
        public static class InterlockTest {
            ...
            public static class Interlocker implements Runnable {
                public void run () {
                    lock.acquire();
                    for (int i = 0; i < 10; i++) {
                        System.out.println(KThread.currentThread().getName()+i);
                        cv.wake();   // signal
                        cv.sleep();  // wait
                    }
                    lock.release();
...
//	public static void sleepThreadTest{
//        Lock lock;
//        Condition2 cv;
//
...
//        		d = 5000;
//        		System.out.println(KThread.currentThread().getName()+" will sleep for "+d+"ticks from "+t0);
//        		cv.sleepFor(d);
